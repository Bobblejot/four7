...
module.exports.DEFAULTS = RECESS.DEFAULTS = {
	compile: false, compress: false, config: false, format: 'text', includePath: [], noIDs: true, noJSPrefix: true, noOverqualifying: true, noSummary: false, noUnderscores: true, noUniversalSelectors: true, prefixWhitespace: true, strictPropertyOrder: true, stripColors: false, watch: false, zeroUnits: true, inlineImages: false
}
