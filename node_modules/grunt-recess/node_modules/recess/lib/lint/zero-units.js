...
var util = require('../util')
	...
	, RULE = {
		type: 'zeroUnits', exp: new RegExp('\\b0\\s?(' + units.join('|') + ')'), message: 'No need to specify units when a value is 0'
	}
...
module.exports = function (def, data) {
	...
	def.rules.forEach(function (rule) {
		...
		util.throwError(def, {
			type: RULE.type, message: RULE.message, extract: extract, line: line
		})
