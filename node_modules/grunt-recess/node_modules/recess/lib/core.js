...
RECESS.prototype = {
	...
	constructor      : RECESS, log: function (str, force) {
		...
		var that = this
			, options = {
				paths: [path.dirname(this.path)].concat(this.options.includePath), optimization: 0, filename: this.path && this.path.replace(/.*(?=\/)\//, '')
			}
