...
<!--[if lt IE 8]>
<?php echo $fs_framework->alert( 'warning', __('You are using an <strong>outdated</strong> browser. Please
<a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.', 'four7') ); ?>
<![endif]-->
...
<div id="content" class="content">
	...
	<main class="main <?php four7_section_class( 'main', true ); ?>" <?php if ( is_home() ) {
		echo 'id="home-blog"';
	} ?> role="main">
