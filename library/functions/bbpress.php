...
function four7_bbp_forum_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';

	return $classes;
}
add_filter('bbp_get_forum_class', 'four7_bbp_forum_class');

function four7_bbp_topic_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';
	$classes[] = four7_bbps_get_topic_status();

	return $classes;
}
add_filter('bbp_get_topic_class', 'four7_bbp_topic_class');

function four7_bbp_reply_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';

	return $classes;
}
add_filter('bbp_get_reply_class', 'four7_bbp_reply_class');

function four7_bbp_styles() { ?>
	<style type="text/css">
...
add_action( 'wp_head', 'four7_bbp_styles' );
 ...
 */
function four7_bbp_form_topic_type_dropdown( $args = '' ) {
	echo four7_bbp_get_form_topic_type_dropdown( $args );
}
	/**
	 ...
	 */
	function four7_bbp_get_form_topic_type_dropdown( $args = '' ) {
 ...
 */
function four7_bbp_form_topic_status_dropdown( $args = '' ) {
	echo four7_bbp_get_form_topic_status_dropdown( $args );
}
	/**
	 ...
	 *  - selected: Override the selected option
	 */
	function four7_bbp_get_form_topic_status_dropdown( $args = '' ) {
 ...
 */
function four7_bbp_user_subscribe_link( $args = '', $user_id = 0, $wrap = true ) {
	echo four7_bbp_get_user_subscribe_link( $args, $user_id, $wrap );
}
	/**
	 ...
	 */
	function four7_bbp_get_user_subscribe_link( $args = '', $user_id = 0, $wrap = true ) {
 ...
 */
function four7_bbp_user_favorites_link( $args = array(), $user_id = 0, $wrap = true ) {
	echo four7_bbp_get_user_favorites_link( $args, $user_id, $wrap );
}
	/**
	 * User favorites link
	 *
	 ...
	 */
	function four7_bbp_get_user_favorites_link( $args = '', $user_id = 0, $wrap = true ) {
...
add_action('bbp_template_before_single_topic', 'four7_bbps_add_support_forum_features');
function four7_bbps_add_support_forum_features(){	
		...
		<div id ="bbps_support_forum_move">
			<form id="bbps-topic-move" class="form-horizontal" role="form" name="bbps_support_topic_move" action="" method="post">
				<div class="form-group">
					<label for="bbp_forum_id" class="control-label">Move topic to: </label><?php four7_bbp_dropdown(); ?>
 ...
 */
function four7_bbp_dropdown( $args = '' ) {
	echo four7_bbp_get_dropdown( $args );
}
	/**
	 ...
	 */
	function four7_bbp_get_dropdown( $args = '' ) {
...
function four7_bbps_get_topic_status() {
	$topic_id = bbp_get_topic_id();
