...
function four7_media_grabber( $args = array() ) {
	...
	$media = new four7_Media_Grabber( $args );
...
class four7_Media_Grabber {
	...
	public function __construct( $args = array() ) {
		...
		$this->args    = apply_filters( 'four7_media_grabber_args', wp_parse_args( $args, $defaults ) );
	...
	public function get_media() {
		return apply_filters( 'four7_media_grabber_media', $this->media, $this );
	}
	...
	public function do_embed_shortcode_media( $shortcode ) {
		...
		$this->media = apply_filters(
			'four7_media_grabber_embed_shortcode_media',
			$this->original_media
		);
	}
