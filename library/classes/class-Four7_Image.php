...
if ( ! class_exists( 'Four7_Image' ) ) {
	...
	*/
	class Four7_Image {
		...
		/*
		 * Proxy function to be called whenever an image is used. If you wish to resize, use four7_image_resize()
		 */
		...
		public static function _resize( $url, $width = NULL, $height = NULL, $crop = true, $retina = false ) {
			...
			if ( empty( $url ) ) {
				return new WP_Error( 'no_image_url', __( 'No image URL has been entered.', 'four7' ), $url );
			}
