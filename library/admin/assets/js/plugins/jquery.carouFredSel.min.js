...
(function ($) {
	...
	function sc_hideHiddenItems(a) {
		a.each(function () {
			var a = $(this);
			a.data("_css_isHidden", a.is(":hidden")).hide()
		})
	}
	...
	function sz_storeMargin(a, b, c) {
		b.usePadding && (is_string(c) || (c = "_css_origCssMargin"), a.each(function () {
	...
	function sz_resetMargin(a, b, c) {
		if (b.usePadding) {
			...
			is_number(c) || (c = 0), sz_storeMargin(a, b, "_css_tempCssMargin"), a.each(function () {
				var a = $(this);
				a.css(b.d.marginRight, d ? a.data("_css_tempCssMargin") : c + a.data("_css_origCssMargin"))
			})
		}
	}
	...
	function sz_storeOrigCss(a) {
		a.each(function () {
			var a = $(this);
			a.data("_css_origCss", a.attr("style") || "")
		})
	}
	...
	function sz_restoreOrigCss(a) {
		a.each(function () {
			var a = $(this);
			a.attr("style", a.data("_css_origCss") || "")
		})
	}
	...
	function sz_setSizes(a, b) {
		...
		if (c.css(f), b.usePadding) {
			...
			b.align && 0 > h && (h = 0);
			var i = e.last();
			i.css(b.d.marginRight, i.data("_css_origCssMargin") + h), a.css(b.d.top, g[b.d[0]]), a.css(b.d.left, g[b.d[3]])
		}
	...
	$.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
		...
		$cfs.data("_css_isCarousel") && (starting_position = $cfs.triggerHandler("_css_triggerEvent", "currentPosition"), $cfs.trigger("_css_triggerEvent", ["destroy", !0]));
		var FN = {};
		FN._init = function (a, b, c) {
			...
			"parent" == conf.wrapper ? sz_storeOrigCss($wrp) : $wrp.css(b), $wrp.css({overflow: "hidden", position: c}), sz_storeOrigCss($cfs), $cfs.data("_css_origCssZindex", b.zIndex), $cfs.css({textAlign: "left", "float": "none", position: "absolute", top: 0, right: "auto", bottom: "auto", left: 0, marginTop: 0, marginRight: 0, marginBottom: 0, marginLeft: 0}), sz_storeMargin(a, opts), sz_storeOrigCss(a), opts.responsive && sz_setResponsiveSizes(opts, a)
			...
			FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function (a, b) {
				...
				if (tmrs.timePassed = 0, $cfs.trigger(cf_e("slide_" + j, conf), [b, c]), opts.synchronise)for (var m = opts.synchronise, n = [b, c], o = 0, l = m.length; l > o; o++) {
					var p = j;
					m[o][2] || (p = "prev" == p ? "next" : "prev"), m[o][1] || (n[0] = m[o][0].triggerHandler("_css_triggerEvent", ["configuration", p])), n[1] = c + m[o][3], m[o][0].trigger("_css_triggerEvent", ["slide_" + p, n])
				}
				return!0
				...
				if ($cfs.css(B), scrl = sc_setScroll(D, b.easing, conf), w[opts.d.left] = opts.usePadding ? opts.padding[opts.d[3]] : 0, ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) && (E = function () {
					...
					switch (k.not(i).length && (y[opts.d.marginRight] = i.data("_css_origCssMargin"), 0 > l ? i.css(y) : (K = function () {
						i.css(y)
					}, L = function () {
						scrl.anims.push([i, y])
					})), b.fx) {
					...
					k.not(j).length && (z[opts.d.marginRight] = j.data("_css_origCssMargin"), G = function () {
						j.css(z)
					}, H = function () {
						scrl.anims.push([j, z])
					}), m >= 0 && (A[opts.d.marginRight] = k.data("_css_origCssMargin") + opts.padding[opts.d[1]], I = function () {
						k.css(A)
					}, J = function () {
						scrl.anims.push([k, A])
					})
				...
				N = function () {
					if (P > 0 && ($cfs.children().slice(itms.total).remove(), g = $($cfs.children().slice(itms.total - (opts.items.visible - P)).get().concat($cfs.children().slice(0, P).get()))), sc_showHiddenItems(p), opts.usePadding) {
						...
						a.css(opts.d.marginRight, a.data("_css_origCssMargin"))
					}
				};
				...
				if (scrl = sc_setScroll(B, b.easing, conf), w[opts.d.left] = -t, x[opts.d.left] = -v, 0 > m && (w[opts.d.left] += m), ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) && (C = function () {
					...
					var L = l.data("_css_origCssMargin");
					n >= 0 && (L += opts.padding[opts.d[1]]), l.css(opts.d.marginRight, L), j.not(k).length && (z[opts.d.marginRight] = k.data("_css_origCssMargin")), E = function () {
						k.css(z)
					}, F = function () {
						scrl.anims.push([k, z])
					};
					var M = j.data("_css_origCssMargin");
				...
				J = function () {
					...
					if (N > 0 && (i = gi_getCurrentItems(d, opts)), sc_showHiddenItems(p), opts.usePadding) {
						if (itms.total < opts.items.visible + c) {
							...
							b.css(opts.d.marginRight, b.data("_css_origCssMargin") + opts.padding[opts.d[1]])
						}
						a.css(opts.d.marginRight, a.data("_css_origCssMargin"))
					}
				};
				...
				switch (I = function () {
					$cfs.css("zIndex", $cfs.data("_css_origCssZindex")), sc_afterScroll($cfs, s, b), crsl.isScrolling = !1, clbk.onAfter = sc_fireCallbacks($tt0, b, "onAfter", O, clbk), queu = sc_fireQueue($cfs, queu, conf), crsl.isPaused || $cfs.trigger(cf_e("play", conf))
				...
				return a.stopPropagation(), tmrs = sc_clearTimers(tmrs), $cfs.data("_css_isCarousel", !1), $cfs.trigger(cf_e("finish", conf)), b && $cfs.trigger(cf_e("jumpToStart", conf)), sz_restoreOrigCss($cfs.children()), sz_restoreOrigCss($cfs), FN._unbind_events(), FN._unbind_buttons(), "parent" == conf.wrapper ? sz_restoreOrigCss($wrp) : $wrp.replaceWith($cfs), !0
			}), $cfs.bind(cf_e("debug", conf), function () {
				return debug(conf, "Carousel width: " + opts.width), debug(conf, "Carousel height: " + opts.height), debug(conf, "Item widths: " + opts.items.width), debug(conf, "Item heights: " + opts.items.height), debug(conf, "Number of items visible: " + opts.items.visible), opts.auto.play && debug(conf, "Number of items scrolled automatically: " + opts.auto.items), opts.prev.button && debug(conf, "Number of items scrolled backward: " + opts.prev.items), opts.next.button && debug(conf, "Number of items scrolled forward: " + opts.next.items), conf.debug
			}), $cfs.bind("_css_triggerEvent", function (a, b, c) {
				return a.stopPropagation(), $cfs.triggerHandler(cf_e(b, conf), c)
			})
		}, FN._unbind_events = function () {
			$cfs.unbind(cf_e("", conf)), $cfs.unbind(cf_e("", conf, !1)), $cfs.unbind("_css_triggerEvent")
