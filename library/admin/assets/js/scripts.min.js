...
var ExampleSite = {common: {init: function () {
	var a = function () {
		jQuery().carouFredSel && (jQuery(".clients-carousel").each(function () {
			jQuery(this).find("ul").carouFredSel({auto: !1, prev: jQuery(this).find(".es-nav-prev"), next: jQuery(this).find(".es-nav-next"), width: "100%"})
		}), jQuery(".es-carousel-wrapper").each(function () {
			jQuery(this).find("ul").carouFredSel({auto: !1, prev: jQuery(this).find(".es-nav-prev"), next: jQuery(this).find(".es-nav-next"), width: "100%"})
		}), jQuery(".products-slider").each(function () {
			var a = jQuery(this).find("ul");
			a.carouFredSel({auto: !1, prev: jQuery(this).find(".es-nav-prev"), next: jQuery(this).find(".es-nav-next"), align: "left", left: 0, width: "100%", height: "variable", responsive: !0, scroll: {items: 1}, items: {width: 500, height: "variable", visible: {min: 1, max: 30}}})
		}))
	};
	jQuery(".progress-bar").each(function () {
		var a = jQuery(this).find(".progress-bar-content").data("percentage");
		jQuery(this).find(".progress-bar-content").css("width", "0%"), jQuery(this).find(".progress-bar-content").animate({width: a + "%"}, "slow")
	}), jQuery().waypoint && jQuery("#progress-bars").waypoint(function () {
		jQuery(".progress-bar").each(function () {
			var a = jQuery(this).find(".progress-bar-content").data("percentage");
			jQuery(this).find(".progress-bar-content").css("width", "0%"), jQuery(this).find(".progress-bar-content").animate({width: a + "%"}, "slow")
		})
	}, {triggerOnce: !0, offset: "100%"}), jQuery(".display-percentage").each(function () {
		var a = jQuery(this).data("percentage");
		jQuery(this).countTo({from: 0, to: a, speed: 900})
	}), jQuery().waypoint && jQuery(".counters-box").waypoint(function () {
		jQuery(this).find(".display-percentage").each(function () {
			var a = jQuery(this).data("percentage");
			jQuery(this).countTo({from: 0, to: a, speed: 900})
		})
	}, {triggerOnce: !0, offset: "100%"}), jQuery(".simple-products-slider .product-buttons a").text(""), jQuery("[data-toggle=popover]").popover(), jQuery("#myTab a:first").tab("show"), a(), jQuery("ul.nav li.dropdown, ul.nav li.dropdown-submenu").hover(function () {
