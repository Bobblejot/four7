...
class FOUR7_Framework_Core {
    ...
    public function open_container( $element = 'div', $id = null, $extra_classes = null, $properties = null ) {
        ...
        if ( ! is_null( apply_filters( 'four7_container_class', $this->defines['container'] ) ) ) {
            $default_classes = explode( ' ', apply_filters( 'four7_container_class', $this->defines['container'] ) );
