...
add_action( 'wp_head', 'four7_meta_robots', 1 );
add_action( 'wp_head', 'four7_meta_author', 1 );
add_action( 'wp_head', 'four7_meta_copyright', 1 );
add_action( 'wp_head', 'four7_meta_revised', 1 );
add_action( 'wp_head', 'four7_meta_description', 1 );
