...
class four7_Widget_Contact_Info extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		<span class="email"><?php _e('Email:', 'four7'); ?> <a href="mailto:<?php echo $instance['email']; ?>"><?php if($instance['emailtxt']) { echo $instance['emailtxt']; } else { echo $instance['email']; } ?></a></span><br>
		<?php endif; ?>

		<?php if($instance['web']): ?>
		<span class="web"><?php _e('Web:', 'four7'); ?> <a href="<?php echo $instance['web']; ?>"><?php if($instance['webtxt']) { echo $instance['webtxt']; } else { echo $instance['web']; } ?></a></span><br>
		<?php endif; ?>
		</p></address>
		<?php
		echo $after_widget;
