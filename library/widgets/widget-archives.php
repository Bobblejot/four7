...
class four7_Widget_Archives extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		$this->WP_Widget(
			'inevisys-archives', // $this->id_base
		...
		<div class="inevisys-widget-controls columns-2 column-last">
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'show_post_count' ); ?>">
					<input class="checkbox" type="checkbox" <?php checked( $instance['show_post_count'], true ); ?> id="<?php echo $this->get_field_id( 'show_post_count' ); ?>" name="<?php echo $this->get_field_name( 'show_post_count' ); ?>" /> <?php _e( 'Show post count?', $this->textdomain ); ?>
