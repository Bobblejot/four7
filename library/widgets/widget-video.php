<?php
	...
	*/
	...
	class four7_Widget_Video extends WP_Widget {
		
		function four7_Widget_Video() {			
			...
			$this->WP_Widget( 'video-widget', 'Four7 Video Widget', $widget_ops, $control_ops );
		}
	...
	?>
		...
		<p>
			<label><?php _e('Video URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Width', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Height', 'four7');?>:</label>
	...
	add_action( 'widgets_init', 'load_video_widget' );
	
	function load_video_widget() {
