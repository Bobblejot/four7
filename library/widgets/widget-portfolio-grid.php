<?php
	...
	*/
	...
	// Register widget
	add_action( 'widgets_init', 'init_four7_Widget_Portfolio_Grid' );
	function init_four7_Widget_Portfolio_Grid() { return register_widget('four7_Widget_Portfolio_Grid'); }
	
	class four7_Widget_Portfolio_Grid extends WP_Widget {
		function four7_Widget_Portfolio_Grid() {
			parent::WP_Widget( 'four7_Widget_Portfolio_Grid', $name = 'Four7 Portfolio Grid' );
		}
		...
		function form( $instance ) {	
				...
				<p>
					<label for="<?php echo $this->get_field_id('number'); ?>"><?php echo __( 'Number of items to show:', 'four7' ); ?></label>
