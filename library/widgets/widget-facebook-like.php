...
class four7_Widget_facebook_Like extends WP_Widget {

	function four7_Widget_facebook_Like() {
		$widget_ops = array( 'classname' => 'four7_facebook_like', 'description' => 'Adds support for facebook Like Box.' );

		$control_ops = array( 'id_base' => 'four7_facebook-like-widget' );

		$this->WP_Widget( 'four7_facebook-like-widget', 'four7: facebook Like Box', $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array( 'title' => 'Find us on four7_facebook', 'page_url' => '', 'width' => '268', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page_url' ); ?>">four7_facebook Page URL:</label>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id( 'color_scheme' ); ?>" name="<?php echo $this->get_field_name( 'color_scheme' ); ?>" class="widefat" style="width:100%;">
				<option <?php if ( 'light' == $instance['color_scheme'] ) {
					echo 'selected="selected"';
				} ?>>light</option>
				<option <?php if ( 'dark' == $instance['color_scheme'] ) {
					echo 'selected="selected"';
				} ?>>dark</option>
			</select>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_header' ); ?>">Show four7_facebook header</label>
		</p>
	<?php
	}
}
