...
class Four7_Vcard_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		wp_cache_set( 'widget_four7_vcard', $cache, 'widget' );
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_four7_vcard'] ) ) {
			delete_option( 'widget_four7_vcard' );
		}
	...
	function flush_widget_cache() {
		wp_cache_delete( 'widget_four7_vcard', 'widget' );
	}
