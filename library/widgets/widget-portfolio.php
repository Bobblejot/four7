<?php
	...
	*/
	...
	// Register widget
	add_action( 'widgets_init', 'init_four7_Widget_Portfolio' );
	function init_four7_Widget_Portfolio() { return register_widget('four7_Widget_Portfolio'); }
	
	class four7_Widget_Portfolio extends WP_Widget {
		function four7_Widget_Portfolio() {
			parent::WP_Widget( 'four7_Widget_Portfolio', $name = 'Four7 Recent Portfolio' );
		}
