 ...
 */
	class four7_Widget_Advertgrid extends WP_Widget {
		
		function four7_Widget_Advertgrid() {			
	...
	?>
		...
		<p>
			<label><?php _e('Title', 'four7');?>:</label>
			<input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" class="widefat" type="text" />
		</p>
		<p>
			<label><?php _e('Image 1 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 1 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 2 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 2 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 3 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 3 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 4 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 4 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 5 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 5 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 6 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 6 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 7 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 7 Link', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 8 URL', 'four7');?>:</label>
		...
		<p>
			<label><?php _e('Image 8 Link', 'four7');?>:</label>
	...
	add_action( 'widgets_init', 'load_advert_grid_widget' );
	
	function load_advert_grid_widget() {
