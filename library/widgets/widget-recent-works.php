...
class four7_Widget_Recent_Works extends WP_Widget {

	function four7_Widget_Recent_Works() {
		$widget_ops = array( 'classname' => 'recent_works', 'description' => 'Recent works from the portfolio.' );

		$control_ops = array( 'id_base' => 'four7_recent_works-widget' );

		$this->WP_Widget( 'four7_recent_works-widget', 'LMC: Recent Works', $widget_ops, $control_ops );
	}
