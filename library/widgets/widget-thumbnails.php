...
class four7_Widget_Thumbnails extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input class="checkbox" type="checkbox" <?php checked( $instance['thumbnails_randomize'], true ); ?> id="<?php echo $this->get_field_id( 'thumbnails_randomize' ); ?>" name="<?php echo $this->get_field_name( 'thumbnails_randomize' ); ?>" /> <?php _e( 'Display in random order', 'inevisys' ); ?></label>
		</p>		
